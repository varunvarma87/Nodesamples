 ...
 * @venus-include ../../lib/ppdustjs-filters-secure.js
...
describe('dust escapeUrl |ul filters works', function() {
  ...
  it('should escape url properly', function() {
	expect(dust.filters.ul('http://www.linkedin.com')).toEqual('http://www.linkedin.com');
   	...
   	expect(dust.filters.ul('https://www.linkedin.com/<script>alert(123)</script>?keywords="\'<script>alert(123)</script>&foo=bar')).toEqual('https&#x3A;&#x2F;&#x2F;www&#x2E;linkedin&#x2E;com&#x2F;&#x3C;script&#x3E;alert&#x28;123&#x29;&#x3C;&#x2F;script&#x3E;&#x3F;keywords&#x3D;%22%27%3Cscript%3Ealert%28123%29%3C%2Fscript%3E&#x26;foo&#x3D;bar');
   	...
   	expect(dust.filters.ul('<script>alert(123)</script>')).toEqual('&#x3C;script&#x3E;alert&#x28;123&#x29;&#x3C;&#x2F;script&#x3E;');
   });
});
