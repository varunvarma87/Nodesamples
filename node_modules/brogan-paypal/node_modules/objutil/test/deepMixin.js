...
describe('deepMixin', function () {
    ...
    it('should handle primitives', function () {
        ...
        src = { foo: 'foo', bar: 'bar', baz: 'baz', bam: 'foobar' };
        dest = { bam: 'bam', wa: 'hoo' };

        objutil.deepMixin(src, dest);
        assert.strictEqual(src.foo, dest.foo);
        assert.strictEqual(src.bar, dest.bar);
        assert.strictEqual(src.baz, dest.baz);
        assert.strictEqual(src.bam, dest.bam);
        assert.strictEqual(dest.wa, 'hoo');
    });
    ...
    it('should handle null', function () {
        ...
        dest = objutil.deepMixin(src, { bam: 'bam' });
    ...
    it('should handle object references', function () {
        ...
        dest = objutil.deepMixin(src, dest);
