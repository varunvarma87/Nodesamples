option java_package = "org.ebayopensource.sherlock.client.frontier.internal";
option java_outer_classname = "Protobuf";
option optimize_for = SPEED;

package sherlock.frontier.v1;
...
message ServerResponseProto {
  ...
  required ReqRespTypeProto type     = 1;
...
message ClientRequestProto {
  ...
  required ReqRespTypeProto type   = 2;
...
message MetricProto {
  ...
  required MetricTypeProto  metric_type = 2;
  required ValueTypeProto   value_type  = 3;
