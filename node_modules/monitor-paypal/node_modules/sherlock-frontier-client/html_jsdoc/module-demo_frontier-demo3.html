...
<head>
	<meta charset="utf-8">
	<title>sherlock-frontier-client Module: demo/frontier-demo3</title>
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<div id="main">
    		<h1 class="page-title">Module: demo/frontier-demo3</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>A demo of Sherlock Frontier client which demonstrates registering a set of metrics and publishing a single sample
for each of them in a single shot using <code>FrontierClient#postUnregistered</code> method.
The demo is invoked with a number of optional command line arguments to control its key settings.</p></div>
