...
<head>
	<meta charset="utf-8">
	<title>sherlock-frontier-client Module: demo/frontier-demo1-GA</title>
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<div id="main">
    		<h1 class="page-title">Module: demo/frontier-demo1-GA</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>A demo of Sherlock Frontier client which demonstrates registering a set of metrics and publishing their time series.
...
the replies only after the request has actually been processed.</p>
<p>Regardless of the chosen reliability level, the demo completes only when every post is acknowledged with a local callback.</p></div>
...
<dl class="details">
	...
	<dd class="tag-author">
		<ul>
			<li>Yuri Finkelstein, December 2014</li>
			</ul>
	</dd>
