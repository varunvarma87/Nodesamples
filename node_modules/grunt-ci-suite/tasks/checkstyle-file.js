/*
* Inspired by JsHint Checkstyle Reporter (Author: Boy Baukema)
* 
*/
module.exports =
{
	reporter: function (results, data)
	{
		...
		var files = {},
			...
			fs = require('fs'),
			path = require('path'),
			resFilePath = process.env.CHECKSTYLE_FILE || path.join(process.cwd(), "/checkstyle.xml"),
			resFile = fs.openSync(resFilePath, 'w', '755');
		...
		console.log("\nWriting the Lint result to file: " + resFilePath);
		fs.writeSync(resFile, out.join("\n") + "\n", null, 'utf-8');
	}
};